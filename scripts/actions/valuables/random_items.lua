local config = {
	...
	[26165] = { -- mysterious remains
		...
		chances = {
			...
			-- Tokens
			{from = 501, to = 1000, itemId = 25377, count = 2}, --5% Gold Token
			{from = 1001, to = 1500, itemId = 25172, count = 2}, --5% Silver Token
			{from = 1501, to = 2000, itemId = 25172, count = 2}, --5% Silver Token
			{from = 2001, to = 2500, itemId = 18423, count = 3}, --5% Major Crystalline Token

			-- Trash
			{from = 2501, to = 3000, itemId = 8838, count = 23}, --5% Potatoes
			{from = 3001, to = 3500, itemId = 12637}, --5% Ectoplasmic Sushi
			{from = 3501, to = 4000, itemId = 2238}, --5% Worn Leather Boots
			{from = 4001, to = 4500, itemId = 13757}, --5% Coal
			...
			{from = 7001, to = 7100, itemId = 2195}, -- 5% Boots of Haste
			--{from = 7001, to = 7500, itemId = 22598}, -- 5% Unrealized Dream
			{from = 7501, to = 7600, itemId = 2472}, --5% MPA
			{from = 8001, to = 8500, itemId = 22598}, -- 5% Unrealized Dream
			{from = 8501, to = 9000, itemId = 20620}, --5% Zaoan Chess Box
			{from = 9001, to = 9300, itemId = 2160, count = 3}, --5% Crystal Coin

			-- 1% Rewards
			{from = 9501, to = 9600, itemId = 35056}, --1% Festive Backpack
			{from = 9601, to = 9700, itemId = 25377, count = 3}, --1% Gold Token
			{from = 9701, to = 9800, itemId = 25172, count = 3}, --1% Silver Token
			{from = 9801, to = 9900, itemId = 10513}, --1% Squeezing Gear of Girlpower
			{from = 9901, to = 9902, itemId = 2471}, -- 0.05% Golden Helmet
			{from = 9906, to = 9907, itemId = 2469}, -- 0.05% Dragon Scale Legs
			{from = 9911, to = 9914, itemId = 8931}, -- 0.05% The Epiphany
			{from = 9916, to = 9917, itemId = 2218}, -- 0.05% Paw Amulet
			...
			{from = 9971, to = 9980, itemId = 35201}, --0.1% Tearesa Doll
