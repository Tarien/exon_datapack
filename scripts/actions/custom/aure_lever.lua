local t = {
	Position(29659, 33146, 4), -- stone position 
}

local aurelius_lever = Action()
function aurelius_lever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
aurelius_lever:uid(50106)
aurelius_lever:register()
