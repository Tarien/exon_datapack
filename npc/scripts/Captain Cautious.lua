...
addTravelKeyword('aurelius', 250, Position(29614, 33188, 6))
...
keywordHandler:addKeyword({'trip'}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want to go to {Vanguard} or {Aurelius}?'})
keywordHandler:addKeyword({'route'}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want to go to {Vanguard} or {Aurelius}?'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want to go to {Vanguard} or {Aurelius}?'})
keywordHandler:addKeyword({'town'}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want to go to {Vanguard} or {Aurelius}?'})
keywordHandler:addKeyword({'destination'}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want to go to {Vanguard} or {Aurelius}?'})
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want to go to {Vanguard} or {Aurelius}?'})
keywordHandler:addKeyword({'go'}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want to go to {Vanguard} or {Aurelius}?'})
