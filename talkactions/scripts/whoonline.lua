...
function onSay(player, words, param)
    ...
    for k, v in pairs(players) do
        player:sendTextMessage(MESSAGE_EVENT_ADVANCE, k .. ". " .. v:getName() .. " Level: " .. v:getLevel() .. " Time online: " .. os.time() - v:getLastLoginSaved())
		-- print("!Online command:")
		print(k .. ". " .. v:getName() .. " Level: " .. v:getLevel() .. " Time online: " .. os.time() - v:getLastLoginSaved())
    end
