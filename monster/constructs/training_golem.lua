local mType = Game.createMonsterType("Training Golem")
local monster = {}

monster.description = "a training golem"
...
monster.race = "BESTY_RACE_HUMANOID"
...
monster.voices = {
	interval = 5000,
	chance = 10,
	{text = "You.. Will be trained..", yell = false},
	{text = "klonk klonk klonk", yell = false},
	{text = "Rrrtttarrrttarrrtta", yell = false},
	{text = "Commencing self-distru..Training. Training commenced.", yell = false},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = 0, range = 1, shootEffect = CONST_ANI_SMALLSTONE, target = false}
}

monster.defenses = {
	defense = 2,
	armor = 2,
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_HEALING, minDamage = 4000, maxDamage = 4500, effect = CONST_ME_MAGIC_BLUE, target = false}
}
